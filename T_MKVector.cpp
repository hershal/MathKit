...
attribute_t_ptr run_random_insertion_test_out_of_bounds();
...
int main() {
    ...
    for (auto i=0; i<len; ++i) {
        tot = accumulate_results(run_random_insertion_test_out_of_bounds(), tot);
    }
